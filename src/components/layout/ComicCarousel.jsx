  ...
  return (
    <Carousel opts={{ watchDrag: false }} className="w-full">
      <CarouselContent className="flex justify-center items-center m-0">
        <CarouselItem className="basis-1/6 flex items-center justify-center h-[40vh] border-4 pl-0">
          {comicList[0].img ? (
            <img
              src={comicList[0].img}
        ...
        <CarouselItem className="sm:basis-5/5 lg:basis-3/5 flex flex-col overflow-auto h-[80vh] border-4 pl-0 m-4">
